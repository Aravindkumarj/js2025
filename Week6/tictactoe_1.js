...
function did_I_Win() {
    ...
    if ((com1.every(value => value == ('X'))) || (com2.every(value => value == ('X'))) || (com3.every(value => value == ('X'))) || (com4.every(value => value == ('X'))) || (com5.every(value => value == ('X'))) || (com6.every(value => value == ('X'))) || (com7.every(value => value == ('X'))) || (com8.every(value => value == ('X')))) {
        alert("Won")
        buttons.forEach(button => {
    ...
    if ((com1.every(value => value == ('O'))) || (com2.every(value => value == ('O'))) || (com3.every(value => value == ('O'))) || (com4.every(value => value == ('O'))) || (com5.every(value => value == ('O'))) || (com6.every(value => value == ('O'))) || (com7.every(value => value == ('O'))) || (com8.every(value => value == ('O')))) {
        alert("Won")
        buttons.forEach(button => {
            let buttonInQuestion3 = document.getElementById(button)
            buttonInQuestion3.disabled = true
